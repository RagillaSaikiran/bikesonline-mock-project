...
import getBuyerInfo from '@salesforce/apex/B2BAddressSelection.getBuyerInfo';
import getCartItemsById from '@salesforce/apex/B2BAddressSelection.getCartItemsById';
import getContactPointAddress from '@salesforce/apex/B2BAddressSelection.getContactPointAddress';
import getOrderProductSummaryById from '@salesforce/apex/B2BAddressSelection.getOrderProductSummaryById';
import communityId from '@salesforce/community/Id';

export default class B2b_orderReview extends LightningElement {
    currentCartId;
