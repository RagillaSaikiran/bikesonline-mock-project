...
export default class b2b_ProductDetailsDisplay extends NavigationMixin(
    ...
    /**
     * Gets or sets whether the product has Inventory or not"
     *
    ...
    get inStock()
    {
        return this.inventoryData.Status__c == 'InStock';
    }


    /**
     * Gets whether Available Quantity is less than 10 or not to show Availability Message.
     */
    get availMessage()
    {
        return this.inventoryData.Available_for_Purchase__c<=10;
    }
    ...
    /**
     * Emits a notification that the user wants to Create Case for reminding him to tell about about when its available again.
     *
     * @fires ProductDetailsDisplay#createcase
     * @private
     */
    notifyCreateCase() {
