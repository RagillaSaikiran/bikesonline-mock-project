...
import getInventory from '@salesforce/apex/B2BGetInfo.getInventory';
import addToCart from '@salesforce/apex/B2BGetInfo.addToCart';
import createCase from '@salesforce/apex/B2BGetInfo.createCase';
import updateInventory from '@salesforce/apex/B2BGetInfo.updateInventory';
import updateStatus from '@salesforce/apex/B2BGetInfo.updateStatus';
...
export default class b2b_ProductDetails extends LightningElement {
    ...
    /**
     * The full Inventory inforation retrieved
     *
    ...
    /**
     * Handles a user request to ceate case for the  product to their active cart.
     * On success, a success toast is shown to let the user know the product was added to their cart
     * If there is an error, an error toast is shown with a message explaining that the product could not be added to the cart
     *
     * Toast documentation: https://developer.salesforce.com/docs/component-library/documentation/en/lwc/lwc.use_toast
            ...
            .catch(() => {
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Error',
                        message:
                            'Could not be send Case at this time. Please try again later.',
                        messageData: [this.displayableProduct.name],
                        variant: 'error',
                        mode: 'dismissable'
                    })
