...
import removeCartItem from '@salesforce/apex/B2BCartControllerSample.removeCartItem';
import clearCartItems from '@salesforce/apex/B2BCartControllerSample.clearCartItems';
import quantityChange from '@salesforce/apex/B2BCartControllerSample.quantityChange';
import inventory from '@salesforce/apex/B2BCartControllerSample.inventory';
        ...
        .then((result)=>{
            ...
            if(quantity > this.available_stock)
            {
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Error',
                        message: 'Only '+this.available_stock+' left in stock!',
                        variant : 'error'
                    })
                );
